...
-- Create indexes for frequently queried columns across all tables
...
CREATE INDEX IF NOT EXISTS idx_real_time_notifications_user_id ON public.real_time_notifications(user_id);
CREATE INDEX IF NOT EXISTS idx_real_time_notifications_read ON public.real_time_notifications(read);
CREATE INDEX IF NOT EXISTS idx_real_time_notifications_type ON public.real_time_notifications(type);
...
-- POS Agents indexes
CREATE INDEX IF NOT EXISTS idx_pos_agents_user_id ON public.pos_agents(user_id);
CREATE INDEX IF NOT EXISTS idx_pos_agents_location ON public.pos_agents USING GIN(location);
CREATE INDEX IF NOT EXISTS idx_pos_agents_status ON public.pos_agents(status);
...
-- Create policy for sensitive data access log
CREATE POLICY "Admins can view sensitive data access log" ON public.sensitive_data_access_log
FOR SELECT USING (is_admin());

-- Create indexes for sensitive data access log
CREATE INDEX IF NOT EXISTS idx_sensitive_access_user_id ON public.sensitive_data_access_log(user_id);
CREATE INDEX IF NOT EXISTS idx_sensitive_access_table_name ON public.sensitive_data_access_log(table_name);
CREATE INDEX IF NOT EXISTS idx_sensitive_access_created_at ON public.sensitive_data_access_log(created_at);
